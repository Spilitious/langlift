...
export const historyTransitions = [
  "",

  // 1
  `Vous achevez à peine la créature qu'un nouveau bruit résonne dans les galeries.
Deux nouveaux rats géants surgissent de l'ombre...`,
